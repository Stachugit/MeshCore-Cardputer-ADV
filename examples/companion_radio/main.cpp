...
void setup() {
  ...
  #ifdef ST7789
    disp->setTextSize(3);
    disp->drawTextCentered(disp->width() / 2, 40, "MeshCore");
    disp->setTextSize(1);
    disp->drawTextCentered(disp->width() / 2, 70, "Loading...");
  #else
    disp->setTextSize(2);
    disp->drawTextCentered(disp->width() / 2, 20, "MeshCore");
    disp->setTextSize(1);
    disp->drawTextCentered(disp->width() / 2, 40, "Loading...");
  #endif
    disp->endFrame();
  }
#endif
